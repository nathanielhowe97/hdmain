...
function renderPosts(){
    ...
    function showPost5(){
        ...
        blog5.innerHTML += '<div class="blog-cta">      <a class="view-img" href="../images/products/mosaic_cross.jpg" target="_blank"> <span class="cta-text cta">See attached image</span> </a> </div>'
    ...
    function showPost3(){
        ...
        blog3.innerHTML += '<div class="blog-cta">      <a class="view-img" href="../images/products/snoopy.jpg" target="_blank"> <span class="cta-text cta">See attached image</span> </a> </div>'
    ...
    function showPost2(){
        ...
        blog2.innerHTML += '<div class="blog-cta">      <a class="view-img" href="../images/products/upcycled_camera.jpg" target="_blank"> <span class="cta-text cta">See attached image</span> </a> </div>'
    ...
    function showPost1(){
        ...
        blog1.innerHTML += '<div class="blog-cta">      <a class="view-img" href="../images/products/upcycled_table.jpg" target="_blank"> <span class="cta-text cta">See attached image</span> </a> </div>'
